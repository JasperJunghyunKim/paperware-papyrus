...
export default function Component() {
  ...
  const data = Queries.Metadata.useGetPaperGroupList({
    skip,
    take,
    ...search,
  });
...
function PopupCreate(props: { open: boolean; onClose: (unit: false) => void }) {
  ...
  const api = Queries.Metadata.useCreatePaperGroup();
...
function PopupUpdate(props: {
  ...
  const data = Queries.Metadata.useGetPaperGroupItem({
    id: props.open ? props.open : undefined,
  });

  const api = Queries.Metadata.useUpdatePaperGroup();
  const action = useCallback(async () => {
