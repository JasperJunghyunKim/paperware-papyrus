...
export default function Component() {
  ...
  const data = Queries.Metadata.useGetManufacturerList({
    skip,
    take,
    ...search,
  });
...
function PopupCreate(props: { open: boolean; onClose: (unit: false) => void }) {
  ...
  const api = Queries.Metadata.useCreateManufacturer();
...
function PopupUpdate(props: {
  ...
  const data = Queries.Metadata.useGetManufacturerItem({
    id: props.open ? props.open : undefined,
  });

  const api = Queries.Metadata.useUpdateManufacturer();
  const action = useCallback(async () => {
