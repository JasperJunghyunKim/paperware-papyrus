...
export default function Component() {
  ...
  const data = Queries.Metadata.useGetPaperTypeList({
    skip,
    take,
    ...search,
  });
...
function PopupCreate(props: { open: boolean; onClose: (unit: false) => void }) {
  ...
  const api = Queries.Metadata.useCreatePaperType();
...
function PopupUpdate(props: {
  ...
  const data = Queries.Metadata.useGetPaperTypeItem({
    id: props.open ? props.open : undefined,
  });

  const api = Queries.Metadata.useUpdatePaperType();
  const action = useCallback(async () => {
