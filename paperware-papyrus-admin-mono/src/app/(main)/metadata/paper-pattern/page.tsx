...
export default function Component() {
  ...
  const data = Queries.Metadata.useGetPaperPatternList({
    skip,
    take,
    ...search,
  });
...
function PopupCreate(props: { open: boolean; onClose: (unit: false) => void }) {
  ...
  const api = Queries.Metadata.useCreatePaperPattern();
...
function PopupUpdate(props: {
  ...
  const data = Queries.Metadata.useGetPaperPatternItem({
    id: props.open ? props.open : undefined,
  });

  const api = Queries.Metadata.useUpdatePaperPattern();
  const action = useCallback(async () => {
